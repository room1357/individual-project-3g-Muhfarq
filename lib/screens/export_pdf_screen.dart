        ...
        child: GridView.count(
          ...
          children: [
            _buildExportOption(
              ...
              onTap: () => controller.handleAction('preview', context),
            ),
            _buildExportOption(
              icon: Icons.print,
              title: 'Cetak PDF',
              ...
              bgColor: const Color(0xFFABEFCA),
              onTap: () => controller.handleAction('print', context),
            ),
            _buildExportOption(
              icon: Icons.share,
              title: 'Bagikan PDF',
              color: const Color(0xFF1DC981),
              bgColor: const Color(0xFFABEFCA),
              onTap: () => controller.handleAction('share', context),
            ),
            _buildExportOption(
              icon: Icons.download,
              title: 'Unduh PDF',
              color: const Color(0xFF0B5A3D),
              bgColor: const Color(0xFFABEFCA),
              onTap: () => controller.handleAction('download', context),
            ),
          ],
        ),
      ),
